...
apex.binding=function(e,t,n,i){"use strict";const a="apexBinding",u="ab-".length,l=Object.values,s=new Map,o=new Map,r="item";let c=1;function f(e,t){s.set(e,t)}function d(e){return new Error("Unknown data reference type: "+e)}function p(e){return new Error("Unknown UI binding type: "+e)}function m(e,t){const n=e.type;if(!s.has(n))throw d(n);s.get(n).subscribe(e,t)}function g(e,t){const n=e.type;if(!s.has(n))throw d(n);s.get(n).unsubscribe(e,t)}function b(e,t){let n=null,i=e.indexOf(":");if(i>=0){let a=e.substring(0,i),u=e.substring(i+1);n=s.get(a).parse(u,t)}return n}f(r,{subscribe:function(t,a){const u=t.name,l=i(u);if(!l.node)return void n.error("No such item: ",u);let s=o.get(u);s||(s={subscribers:[],lastValue:l.getValue(),watchId:"bindWatch"+c},c+=1,e(l.node).on("change."+s.watchId,(function(){let e=i(u).getValue();e!==s.lastValue&&(s.lastValue=e,s.subscribers.forEach((e=>{e()})))})),o.set(u,s)),s.subscribers.push(a)},unsubscribe:function(t,n){const a=t.name,u=o.get(a);if(u){const t=i(a);let l=u.subscribers.findIndex((e=>e===n));l>=0&&(u.subscribers.splice(l,1),0===u.subscribers.length&&(e(t.node).off("change."+u.watchId),o.delete(a)))}},getValue:function(e){return i(e.name).getValue()},setValue:function(e,t,n,a,u){i(e.name).setValue(t)},parse:function(e){if(i.isItem(e))return{type:r,name:e}}});const h=new Map;function y(e,t){h.set(e,t)}function w(e){if(!(e&&e instanceof HTMLElement))throw new Error("Invalid binding; missing element")}y("attribute",{validate:function(e){if(w(e.element),!e.attribute||"string"!=typeof e.attribute||0===e.attribute.length)throw new Error("Invalid binding; missing attribute")},key:function(e){return e.type+":"+e.attribute},apply:function(t,n){e(t.element).attr(t.attribute,n)}}),y("text",{validate:function(e){w(e.element)},key:function(e){return e.type},apply:function(t,n){e(t.element).text(n)}}),y("html",{validate:function(e){w(e.element)},key:function(e){return e.type},apply:function(t,n){const i=t.element;let a,u=document.activeElement;e(u).closest(i).length&&(a=u.id),e(i).html(n),a&&e("#"+a).focus()}});let v=!1;var V;function x(t,n,i){const u=t.type;if(!h.has(u))throw p(u);const l=h.get(u);l.validate(t);const o=l.key(t);if(1===n.length&&l.onChange&&void 0===i){let e=n[0],a=e.type;if(!s.has(a))throw d(a);l.onChange(t,((t,n,i,u)=>{s.get(a).setValue(e,t,n,i,u)})),i=function(){return s.get(a).getValue(e)}}let r=0;const c=()=>{r<=0&&(r=1,queueMicrotask((()=>{let e=i();l.apply(t,e),r=0})))},f={dataRefs:n,listener:c},g=e(t.element);let b,y=g.data(a);y||(y={},g.data(a,y)),b=y[o],b&&E(t),y[o]=f;for(const e of n)m(e,c);l.apply(t,i())}function E(t){const n=t.type;if(!h.has(n))throw p(n);if(!(t.element&&t.element instanceof HTMLElement))return;const i=e(t.element),u=h.get(n),l=u.key(t);let s,o=i.data(a);if(o){s=o[l],u.onChange&&u.onChange(t,null);for(const e of s.dataRefs)g(e,s.listener);delete o[l]}}function I(t){const n=e(t).data(a);if(n)for(const e of l(n))for(const t of e.dataRefs)g(t,e.listener)}function k(e,n,i={},a){const u=e.type;let l;return l=t.extractTemplateDependencies(n,i),l=l.map((e=>({type:r,name:e}))),["attribute","text","item-value"].includes(u)?i.defaultEscapeFilter=!1:i.defaultEscapeFilter="HTML",x(e,l,(()=>apex.util.applyTemplate(n,i)))}function M(e){let t=e.querySelectorAll("*");for(const e of t)for(const t of e.getAttributeNames())if(t.startsWith("ab-")){let n,i=e.getAttribute(t),a=t.substring(u);h.has(a)||(n=a,a="attribute");let l={element:e,type:a};if(n&&(l.attribute=n),"item-value"===a&&(l.itemName=e.id),i.startsWith("[")&&i.endsWith("]")){i=i.substring(1,i.length-1);let t=b(i,e),n=t.type;t&&s.has(n)&&x(l,[t])}else k(l,i)}}return y("item-value",{validate:function(e){const t=e.itemName;if(w(e.element),!t||!i.isItem(t))throw new Error("Invalid binding; missing itemName")},key:function(e){return e.type},apply:function(e,t){v=!0,i(e.itemName).setValue(t),v=!1},onChange:function(e,t){let n=i(e.itemName);t?n.element.on("change.uiBinding",(function(){if(!v){let n=i(e.itemName),a=n.getValue(),u=n.getValidity();t(a,n.displayValueFor(a),u,u.valid?"":n.getValidationMessage())}})):n.element.off("change.uiBinding")}}),e.cleanData=(V=e.cleanData,function(t){let n;for(let i=0;null!=(n=t[i]);i++)e.data(n,a)&&I(n);V(t)}),e((()=>{M(document.body)})),{watch:m,unwatch:g,bindTemplate:k,bind:x,unbind:E,applyBindings:M,addDataRefType:f,addBindingType:y}}(apex.jQuery,apex.util,apex.debug,apex.item);
...
apex.widget.util={},function(e,t,a,n,i){"use strict";const o=t.hasOwnProperty,l=Object.entries,s=i.extend,r=13,c=38,u=40,p=".a-Chip--applied",d=".a-Chip-label",h=".a-Chip-text > .a-Chip-value",f="a-Chip--overflow",m=".a-Chip--overflow",v="is-active",g=".is-active",C="is-focused",b=".is-focused",x="is-placeholder",y=":visible",E=".a-ComboSelect-item",P="data-value",T="aria-expanded",w="aria-selected",I="aria-activedescendant",S="aria-busy",_="ITEM_SELECTED",A="contains",L="starts-with",O='<span class="a-Chip-divider" role="separator" aria-orientation="vertical"></span><span class="a-Chip-remove js-removeChip"><span class="a-Icon icon-multi-remove"></span></span>';e.initComboSelect=function(e,n){let o,l,s,A,L,V,M,D,H,$,k,R,X,j,z,F,N=!1,W=null,B=null,U=!1,G=0,Y=null,K=39,q=37,Q=t.getTopApex().jQuery,J=!1,Z=!1,ee=!1,te=".u-hidden",ae=!1,ne=!0,ie=function(){return"<div class='a-ComboSelect-popup non-responsive'></div>"};function oe(e,t,a){let n;return n=!(e>=112&&e<=123||e>=33&&e<=46||e<32),n&&(t||a)&&{65:1,67:1,86:1,88:1,89:1,90:1}[e]&&(n=!1),n}function le(e){let a,i;return e.forEach(((e,t)=>{e.id="CS_"+apex.env.APP_PAGE_ID+"_"+n.baseId+"_option_"+t,e.i&&(a=!0)})),i="{loop APEX$CHOICES/}",n.enterable&&!n.multiValued&&n.hasIcons?(i+="<li role=\"option\" class='a-ComboSelect-item'  tabIndex='-1' {if APEX$ITEM%selected/}aria-selected=\"true\"{endif/} id='&APEX$ITEM%id!ATTR.' >",a&&(i+='<span class="a-ComboSelect-icon a-Icon &APEX$ITEM%i!RAW." aria-hidden="true"></span>'),i+='<span class="a-ComboSelect-label">&APEX$ITEM%d.</span></li>'):i+=n.choiceTemplate,i+="{endloop/}",t.applyTemplate(i,{extraSubstitutions:{APEX$CHOICES:e},defaultEscapeFilter:n.escapeChoices?"HTML":"RAW"})}function se(e){let t=0===e,n=A.text(),i=t?a.getMessage("APEX.CS.NO_MATCHES"):a.formatMessage("APEX.CS.MATCHES_FOUND",e);ee||(i===n&&(i+=" "),A.text(i)),t&&M.popup("close")}function re(){const e=M.parent()[0],t=M[0],a=window.getComputedStyle(e),n=parseFloat(a.top),i=parseFloat(a.bottom),o=parseFloat(window.getComputedStyle(M[0]).height);let l;i<0&&(l=o+i,t.style.maxHeight=l+"px"),n<0&&(l=o+n,t.style.maxHeight=l+"px",e.style.top="0px")}function ce(i){let o=0;if(n.enterable&&!n.multiValued&&(V.attr(S,"true"),V.removeAttr(I)),n.asyncLoading){const e=B.find("li"),t='<span class="a-ComboSelect-label"></span>';o=G+1,G+=1,e.length>0?(e.html(t),e.removeClass(C).find(".a-ComboSelect-icon").remove()):B.html(`\n                        <li role="option" class="a-ComboSelect-item" >\n                            ${t}\n                        </li>\n                    `),B.addClass(x)}n.choices(i,(function(l){let s=le(l);if(o===G){let o,r;if(window.self!==window.parent){const i=function(e){return t.applyTemplate("{loop APEX$CHOICES/} <li role=\"option\" id='&APEX$ITEM%id!ATTR.' ><span>&APEX$ITEM%d.</span></li>\n            {endloop/}",{extraSubstitutions:{APEX$CHOICES:e},defaultEscapeFilter:n.escapeChoices?"HTML":"RAW"})}(l);z=e.find(".a-ComboSelect-popup-mockup"),z.length||(z=e.append(`<div role="dialog" id="${H}"aria-label="${t.escapeHTMLAttr(a.getMessage("APEX.POPUP_LOV.TITLE"))}" class="a-Combobox-popup-mockup u-vh"> <ul role="listbox"></ul></div>`).find(`#${H}`)),z.find("ul").html(i)}B&&(n.asyncLoading&&(o=document.activeElement,r=B[0].contains(o)),B.html(s),B.removeClass(x),n.asyncLoading&&r&&B.find(".a-ComboSelect-item").first().addClass(C).trigger("focus")),!Z&&l.length>0&&!n.asyncLoading&&he(i,s),Z&&l.length>0&&(!function(){const e=M.popup("option").position;e&&(e.collision="fit flip",M.popup({position:e}))}(),re()),n.asyncLoading&&(G=0),n.enterable&&!n.multiValued&&V.attr(S,"false"),setTimeout((()=>{se(l.length)}),0)}}))}function ue(e,a){const o=new RegExp("([<>&;])|("+t.escapeRegExp(a)+")","ig");let l=null,s=n.choices[e],r=!(n.multiValued&&s.selected)&&(!U||s.lc.includes(a.toLowerCase()));return r&&(L+=1,i(this).find(n.itemLabelSelector).html(U?s.d.replace(o,(function(e,t,a){if(t){switch(t){case"<":l=t;break;case">":"<"===l&&(l=null);break;case"&":l||(l=t);break;case";":"&"===l&&(l=null)}return t}return l||!a.length?a:"<span class='a-ComboSelect-itemHighlight'>"+a+"</span>"})):s.d)),!r}function pe(e){$={r:e.attr(P),d:e.find(".a-ComboSelect-label").text()},M.popup("close")}function de(e){if(e){let t=e.d,a=e.r;n.multiValued?Oe(a,t):Le(a,t)}if(i(window).off(R),i("html").off(X),V.off(j),M){let e=M.find(".a-ComboSelect-list").children(b);e.removeClass(C),!n.multiValued&&n.enterable&&e.removeAttr(w)}V.prop("tabIndex",0).attr(T,"false").removeAttr(I).attr(S,"false"),z&&(z.remove(),z=null),ee=!0,setTimeout((()=>{ee=!1,Z=!1,n.enterable&&!n.multiValued&&V.parent().removeClass("js-uses-enter")}),0)}function he(t,l){let s=!0;if(Z=!0,n.multiValued&&o.children(g).removeClass(v),n.onOpen){if(s=!1,!n.onOpen(t,de))return void(Z=!1)}else{if(!(N||n.choices&&0!==n.choices.length))return void(Z=!1);let t={id:H,title:a.getMessage("APEX.POPUP.SEARCH"),isPopup:!0,parentElement:e,returnFocusTo:V[0],noOverlay:!0,takeFocus:!1,width:200,minHeight:20,maxHeight:n.maxHeight||480,okButton:!1,dialogClass:"ui-dialog-comboSelect"+(n.popupClasses?" "+n.popupClasses:""),notification:!1,callback:()=>{de($)},init:function(e){let t="a-ComboSelect-list";n.multiValued&&(t+=" a-ComboSelect--multi"),B=i(`<ul class="${t}" role="listbox"></ul>`),e.append(B),N?N&&!n.asyncLoading&&B.html(l):(B.html(W),B.filterable({enhanced:!0,filterCallback:ue,input:V,children:"li",beforefilter:()=>{L=0},filter:()=>{se(L)}})),B.keydown((function(e){let t,a=e.which,n=B.children(b);a===u?t=n.nextAll(".a-ComboSelect-item").not(te).first():a===c?t=n.prevAll(".a-ComboSelect-item").not(te).first():a!==r&&9!==a||(n[0]&&pe(n),a===r&&e.preventDefault()),t&&t[0]&&(n.removeClass(C),t.addClass(C).trigger("focus"),e.preventDefault())})).on("mousedown",(function(e){0===e.button&&e.preventDefault()})).click((function(e){let t=i(e.target).closest(".a-ComboSelect-item");0===G&&pe(t)}))},open:function(t){let a,o,l,s,r=Q(t.target),c=V.val();$=null,r.data("apex-popup").opener=V,N&&n.asyncLoading?ce(c):N||B.filterable("refresh"),n.width||(a=e.width()),l=i(window).width()-10,s=i(window).height()-10,(n.width||a)>l&&(a=l),n.height>s&&(o=s),a&&r.popup("option","width",a),o&&r.popup("option","height",o),V.on(j,(function(){queueMicrotask((()=>{re()}))}))}};J=!0,M=apex.message.showDialog(ie,t),V.attr("aria-controls",H)}V.attr(T,"true"),n.enterable&&!n.multiValued&&V.parent().addClass("js-uses-enter"),s&&(V.trigger("focus"),J=!1)}function fe(){Z&&M.popup("close")}function me(e){let t;e.addClass(v),t=n.getChipLabel?n.getChipLabel(e):e.find(h).text(),l.attr("aria-live","assertive").text(a.format(n.activeChipMessage,t))}function ve(){fe(),me(V.parent().prevAll(".a-Chip--applied,.a-Chip--overflow").filter(y).first())}function ge(e,t=!0){W&&W.each((function(){let a=i(this);a.attr(P)===e&&a.attr("aria-selected",t?"true":"false")}))}function Ce(){let e=[];o.children(p).each((function(){let t,a,o=i(this);n.getChipLabel?a=n.getChipLabel(o):(a=o.find(h).text(),t=o.find(d).text(),t&&(a=t+" "+a)),e.push(a)})),s.text(e.join(", "))}function be(e){let t=null;return Array.isArray(n.choices)?t=n.choices.find((t=>t.r===e)):n.findChoice&&(t=n.findChoice(e)),t}function xe(e,a,l=""){let s,r=o.children(p);if(s=be(e),(n.enterable||s)&&(!s||a&&n.enterable||(a=s.d),0===r.filter((function(){return i(this).attr(P)===e})).length)){let n=r.last(),c=i(`<li class="a-Chip a-Chip--applied" data-value="${t.escapeHTMLAttr(e)}">${l?`<span class="a-Chip-label">${t.escapeHTML(l)}</span>`:""}<span class="a-Chip-text"><span class="a-Chip-value">${t.escapeHTML(a)}</span></span>${O}</li>`);return s&&(s.selected=!0,ge(e)),n[0]?n.after(c):o.prepend(c),Ce(),Se(),!0}return!1}function ye(e){let t=!1,a=be(e);return a&&(delete a.selected,ge(e,!1)),o.children(p).each((function(){let a=i(this);if(a.attr(P)===e)return a.remove(),Ce(),Se(),t=!0,!1})),t}function Ee(){let e;if(n.multiValued)e=[],o.children(p).each((function(){let t=i(this),a={value:t.attr(P),displayValue:t.find(h).text()},n=t.find(d).text();n&&(a.label=n),e.push(a)}));else{let t=V.attr(P);e=t?{value:t,displayValue:V.val()}:null}return e}function Pe(e,t){let a=be(e),o=be(V.attr(P));if(W&&W.filter("[aria-selected='true']").attr("aria-selected","false"),o&&delete o.selected,n.enterable||a){if(a?(a.selected=!0,t=a.d,ge(e)):t||(t=e),U=!1,V.attr(P,e).val(t),F){const e=i.Event("input");e.apexData={action:_},V.trigger(e,e.apexData)}return!0}return!1}function Te(e,t){return t.addClass(v),n.activateChip&&((e=!n.activateChip(t.attr(P),t,(function(e,a=null,n=null){null!=a&&t.find(d).text(a),null!=n&&t.find(h).text(n),Ie(),e&&V.trigger("focus")})))||t.addClass(v)),e}function we(){V.attr(P,"").val("").parent().addClass("is-empty")}function Ie(){if(n.useOverflow){let e,t,a,n=o.width(),i=0,l=0,s=!1;o.removeClass("a-Chips--wrap"),n-=n/3,e=o.children(p),a=e.length-1;for(let t=a;t>=0;t--){let o=e.eq(t);i+=o.removeClass("is-overflow").width(),i>n&&t<a&&(s=!0,l+=1),i>n&&o.addClass("is-overflow")}t=o.children(m),t.toggleClass("is-overflow",s),s&&t.find(".a-Chip-value").text("+"+l)}}function Se(){let e=0===o.children(p).length;D&&V.attr("placeholder",e?D:""),Ie()}function _e(e){let t=e.attr(P);n.removeValue(t),ye(t)}function Ae(){let e,t=V.val(),a=t.toLowerCase(),i=t;Array.isArray(n.choices)&&(e=n.choices.find((e=>e.lc===a)),e&&(i=e.r)),n.multiValued?Oe(i,t):Le(i,t)}function Le(e,t){n.setValue&&n.setValue(e,t),Pe(e,t)}function Oe(e,t){let a,i;a=n.addValue(e,t),a&&(null!=a.text&&(t=a.text),null!=a.value&&(e=a.value),i=a.label||""),xe(e,t,i),we()}function Ve(e,t,a){if(t!==e){const n=i.Event("change");n.apexData={oldValue:e,value:t},ae=!0,V.trigger(n,n.apexData),a&&(k=t)}}const Me=t.debounce((function(){const e=n.minCharactersSearch;let t=V.val(),a=t.length;a>=e?n.asyncLoading&&!Z?he(t):ce(t):a<e&&Z&&fe()}),250);let De='<li role="option" class="a-ComboSelect-item"data-value="&APEX$ITEM%r!ATTR."tabIndex="-1" {if APEX$ITEM%selected/}aria-selected="true"{endif/}><span class="a-ComboSelect-label">&APEX$ITEM%d.</span></li>';if(n.hasIcons&&n.hasGroups?De='<li role="option" class="{if APEX$ITEM%g/}a-ComboSelect-itemGroup{else/}a-ComboSelect-item{endif/}" data-value="&APEX$ITEM%r!ATTR." tabIndex="-1" {if APEX$ITEM%selected/}aria-selected="true"{endif/}><span class="a-ComboSelect-icon a-Icon &APEX$ITEM%i!ATTR." aria-hidden="true"></span> <span class="a-ComboSelect-label">&APEX$ITEM%d.</span></li>':n.hasIcons?De='<li role="option" class=\'a-ComboSelect-item\' data-value=\'&APEX$ITEM%r!ATTR.\'  tabIndex=\'-1\' {if APEX$ITEM%selected/}aria-selected="true"{endif/} id=\'&APEX$ITEM%id!ATTR.\' > <span class="a-ComboSelect-icon a-Icon &APEX$ITEM%i!ATTR." aria-hidden="true"></span> <span class="a-ComboSelect-label">&APEX$ITEM%d.</span></li>':n.hasGroups&&(De='<li role="option" class="{if APEX$ITEM%g/}a-ComboSelect-itemGroup{else/}a-ComboSelect-item{endif/}" data-value="&APEX$ITEM%r!ATTR." tabIndex="-1" {if APEX$ITEM%selected/}aria-selected="true"{endif/}><span class="a-ComboSelect-label">&APEX$ITEM%d.</span></li>'),F=n.enterable&&!n.multiValued,n=i.extend({escapeChoices:!0,searchIcon:!1,clearIcon:!1,expandIcon:!1,enterable:!1,multiValued:!1,activeChipMessage:"%0. Press back space to delete.",useOverflow:!1,hasIcons:!1,hasGroups:!1,choiceTemplate:De,itemLabelSelector:".a-ComboSelect-label",asyncLoading:!1,minCharactersSearch:0,containerClasses:"apex-item-comboselect",isDisabled:()=>!0},n),H="CS_"+i("#pFlowStepId").val()+"_"+n.baseId,M=Q("#"+t.escapeCSS(H)),M.parent().remove(),R="blur.csPopupTracking"+H,X="mousedown.csPopupTracking"+H,j="focus.csPopupTracking"+H,n.multiValued?te+=",[aria-selected='true']":n.useOverflow=!1,n.containerClasses&&e.addClass(n.containerClasses),n.onOpen||(e.append('<div class="u-vh js-results-description" aria-live="polite"></div>'),A=e.children().last()),V=e.find("input"),V.attr({role:"combobox","aria-expanded":"false",autocomplete:"off",autocorrect:"off",autocapitalize:"none",spellcheck:"false","aria-autocomplete":"list"}),n.enterable&&!n.multiValued&&""===V[0].value&&V.parent().addClass("is-empty"),n.searchIcon&&e.prepend('<span class="a-Icon icon-search" tabindex="-1" aria-hidden="true"></span>'),n.expandIcon){let t=n.expandIcon;!0===t&&(t="icon-popup-lov-under"),n.enterable&&e.append('<span class="a-Chip-divider" role="separator" aria-orientation="vertical"></span>'),e.append(`<button class="a-Button a-Button--popupLOV js-expand" type="button" tabindex="-1" aria-hidden="true"><span class="a-Icon ${t}"></span></button>`)}if("function"==typeof n.choices)N=!0;else if(null!=n.choices&&!Array.isArray(n.choices)){let e=i(n.choices).children(),t=[];e.each((function(){let e=i(this),a=e.attr(P),n=e.attr("data-selected"),o={r:a,d:e.text()};n&&"true"===n.toLowerCase()&&(o.selected=!0),t.push(o)})),e.parent().remove(),n.choices=t}if(Array.isArray(n.choices)&&(n.choices.forEach((e=>{e.lc=t.stripHTML(e.d.toLowerCase())})),W=i(le(n.choices))),n.multiValued){let a=!1,r=null;if(V.val(""),o=e.find("ul").first(),o[0]||(o=i("<ul>"),e.prepend(o)),o.addClass("a-Chips a-Chips--applied"+(n.useOverflow?"":" a-Chips--wrap")).attr("role","presentation").children().each((function(e){let n,o=i(this);o.has("input")[0]?(a=!0,o.addClass("a-Chip a-Chip--input is-empty")):(o.has("span")[0]||(n=o.text(),o.html(`<span class="a-Chip-text"><span class="a-Chip-value">${t.escapeHTML(n)}</span></span>`)),o.append(O).addClass("a-Chip a-Chip--applied"),o.attr(P)||o.attr(P,""+(e+1)),r=o)})),n.useOverflow){let e=i('<li class="a-Chip a-Chip--overflow"><span class="a-Chip-text"><span class="a-Chip-value"></span></span></li>');r?r.after(e):o.prepend(e)}a||(o.append('<li class="a-Chip a-Chip--input is-empty"></li>'),o.find(".a-Chip--input").append(V)),o.after(`<div class="u-vh js-active-description"></div><div id="${n.baseId}_desc" class="u-vh"></div>`),l=o.next(),s=l.next(),V.attr("aria-describedby",n.baseId+"_desc"),Ce()}n.clearIcon&&V.after('<span class="a-Chip-clear js-clearInput" tabindex="-1"><span class="a-Icon icon-multi-remove"></span></span>');let He={options:n,getValue:Ee};return n.multiValued?(He.addValueChip=xe,He.removeValueChip=ye,He.activate=function(e){o.children(g).removeClass(v),o.children(p).each((function(){let t=!1,a=i(this);if(a.attr(P)===e)return t=Te(t,a),t&&V.trigger("focus"),!1}))},He.updatedValueChip=function(){Ce()},He.editValue=function(e,t=e){ye(e),V.val(t)[0].select()},D=V.attr("placeholder"),"rtl"===o.css("direction")&&(K=37,q=39),Se()):He.setValue=Pe,e.on("click",(function(e){let t=!0,a=i(e.target),l=a.closest(".js-removeChip"),s=a.closest(".js-clearInput"),r=a.closest(m),c=a.closest(p);n.isDisabled()||(r[0]?o.addClass("a-Chips--wrap"):l[0]?_e(c):s[0]?we():c[0]&&(o.children(g).removeClass(v),t=Te(!0,c)),t&&setTimeout((()=>{V.trigger("focus")}),0))})).mousedown((function(e){let t=i(e.target),a=t.closest(".js-clearInput"),o=t.closest(".a-Chip--applied,.a-Chip--overflow");if(1&((e=e.originalEvent||e).buttons||1)&&!Z&&!o[0]&&!a[0]){let e=V.val();e.length>=n.minCharactersSearch&&(N&&!n.asyncLoading?ce(e):he())}})).focusout((function(){o&&o.removeClass("is-focused").children(g).removeClass(v),n.enterable&&n.multiValued?V.val()&&!J&&Ae():U&&(Pe(Y.value,Y.displayValue),Y=null),U=!1,J=!1})),V.on("focus",(function(){o&&o.addClass("is-focused"),n.enterable||Y||(Y=Ee()),F&&ne&&(k=V.val(),ne=!1)})).keydown((function(e){let t,a=e.which,i=!1;if(M.length&&(t=M.find(`${E}.is-focused`)),n.multiValued&&""===V.val()){let t=!1,n=o.children(g);if(46===a||8===a)e.target!==V[0]||8!==a||n[0]||ve(),n[0]&&_e(n),t=!0;else if(a===q){if(n[0]){let e=n.prevAll().filter(y);e[0]&&(n.removeClass(v),me(e.first()))}else ve();t=!0}else if(a===K){if(n[0]){let e=n.nextAll().filter(y);e[0]&&(n.removeClass(v),n=e.first(),n.hasClass("a-Chip--input")?l.attr("aria-live","off").text(""):me(n))}t=!0}else a!==r&&32!==a||n[0]&&(n.hasClass(f)?o.addClass("a-Chips--wrap"):a===r&&Te(!0,n),t=!0);if(t)return void e.preventDefault()}if(a===u||a===c){let i=V.val();if(Z||n.enterable&&!(i.length>=n.minCharactersSearch)){if(!n.onOpen&&Z&&(n.asyncLoading&&0===G||!n.asyncLoading)){let i;if(!n.enterable||n.multiValued||n.onOpen)n.multiValued||(i=M.find(".a-ComboSelect-item[aria-selected='true']").first()),i&&i[0]||(i=M.find(".a-ComboSelect-item").not(te).first()),i.addClass(C).focus(),V.prop("tabIndex",-1);else{let e;if(t.length>0?(a===u?e=t.nextAll(".a-ComboSelect-item").not(te).first():a===c&&(e=t.prevAll(".a-ComboSelect-item").not(te).first()),0===e.length?e=t:t.removeClass(C).removeAttr(w)):e=M.find(`${E}:not(${te})`).first(),e.length&&(e.addClass(C).attr(w,"true"),V.attr(I,e[0].id),!function(e,t){const a=e.getBoundingClientRect(),n=t.getBoundingClientRect();return a.top>=n.top&&a.bottom<=n.bottom}(e[0],M[0]))){let t=a===c;e[0].scrollIntoView(t)}}e.preventDefault()}}else N&&!n.asyncLoading?ce(i):he(i)}else a===r?(n.enterable&&n.multiValued&&V.val()&&(Ae(),fe(),e.stopPropagation(),e.stopImmediatePropagation()),F&&!n.onOpen&&Z?t.length?(pe(t),V.parent().toggleClass("is-empty",!1)):Ve(k,V.val(),!0):!F||!n.onOpen&&Z||Ve(k,V.val(),!0),e.preventDefault()):27===a?(Z&&(e.preventDefault(),e.stopPropagation()),fe()):9===a?(n.enterable&&n.multiValued&&V.val()&&Ae(),n.enterable&&!n.multiValued&&!n.onOpen&&Z&&t.length?(pe(t),V.parent().toggleClass("is-empty",!1)):fe()):n.enterable||(i=oe(a,e.ctrlKey,e.metaKey),i&&(U=!0,setTimeout((function(){"x".length>0?he("x"):document.activeElement===undefined[0]&&V.trigger("focus")}),10)))})).keyup((function(e){let t=e.which,a=oe(t,e.ctrlKey,e.metaKey),i=!0;if(n.multiValued&&32===t){let e=o.children(g);e[0]&&!e.hasClass(f)&&(i=!1,Te(!0,e))}N&&a&&i&&Me()})).on("input",(function(e){if(!e.apexData||e.apexData&&e.apexData.action!==_){let e=""===V[0].value;!e&&n.multiValued&&o.children(g).removeClass(v),V.parent().toggleClass("is-empty",e),N&&Me()}})).on("focusout",(function(){F&&(Ve(k,V.val()),ne=!0)})).on("change",(function(e){F&&(ae?ae=!1:e.stopPropagation())})),He};const V=["constructor","widget","option"],M=["create"];e.makeInterfaceFromWidget=function(e,t,a,n=[],i=[]){let o=t[a]("instance"),l=o.options;function s(e,t){o.option(e,t)}for(let t in o)if("function"==typeof o[t]&&"_"!==t[0]&&!n.includes(t)&&!V.includes(t)){if("refresh"!==t&&"focus"!==t&&void 0!==e[t])throw new Error(`Can't overwrite method '${t}'`);e[t]=o[t].bind(o)}for(let t in l)if(!i.includes(t)&&!M.includes(t)){if(void 0!==e[t])throw new Error(`Can't overwrite property '${t}'`);Object.defineProperty(e,t,{enumerable:!0,get:()=>{return e=t,o.option(e);var e},set:e=>{s(t,e)}})}return e.widget=function(){return t},e},e.cascadingLov=function(e,t,a,n){var o=i(e,apex.gPageContext$),l=o[0]?o[0].id:"lov",r=s({optimizeRefresh:!0,queue:{name:l,action:"replace"}},n),c=!1;return r.refreshObject||(r.refreshObject=o),r.loadingIndicator||(r.loadingIndicator=o),r.optimizeRefresh&&(i(r.dependingOn,apex.gPageContext$).each((function(){if(apex.item(this).isEmpty())return c=!0,!1})),c)?(r.refreshObject.trigger("apexbeforerefresh"),"function"==typeof r.clear&&r.clear(),o.trigger("change"),void r.refreshObject.trigger("apexafterrefresh")):(a.pageItems=i(a.pageItems,apex.gPageContext$).add(r.dependingOn),apex.server.plugin(t,a,r))},e.openPopupLov=function(e,n,p,d,h){var f,m,v,g,C,b,x,y,E,P=t.getTopApex().jQuery,T=null,w=d.isPopup||!1,I=a.getMessage("APEX.POPUP_LOV.NO_RESULTS"),S=null,_=d.incrementalSearch,A=d.initialSearch||"",L=i("#"+t.escapeCSS(d.itemId)),O="PopupLov_"+i("#pFlowStepId").val()+"_"+d.itemId,V=O+"_dlg",M=null;function D(){v.resize()}function H(e,a,n,i){var o,l=!1,s=!1,r=f.getOption("fetchData");e.forceRefresh&&(l=!0,"none"!==d.initialFetch||e.typeAhead&&_||(s=!0),r.search=null,e.forceRefresh=!1),null!==a&&a!==r.search&&(r.search=a,l=!0),n&&i&&(n!==r.sortColumn||i!==r.sortDirection)&&(r.sortColumn=n,r.sortDirection=i,l=!0),l&&(o=t.escapeRegExp(r.search).replace(/[_%]/g,(function(e){return"[^<>&]"+("%"===e?"*":"")})),v.options.highlighterContext={term:r.search,re:new RegExp("([<>&;])|("+o+")","ig")},S?a.length>=d.minSearchChars&&!s&&!e.typeAhead?(v._setOption("noDataMessage",I),f.clearData()):(v._setOption("noDataMessage",S),f.setData([]),r.search=null):e.typeAhead&&!_?(f.setData([]),r.search=null):f.clearData(),e.typeAhead=!1)}function $(){E.setItem("state",JSON.stringify(T))}if(d.persistState&&function(){var e;if(E=apex.storage.getScopedSessionStorage({prefix:"ORA_WWV_apex."+O,usePageId:!0,useAppId:!0}),T={},"grid"===d.display&&(T.columnWidths={}),e=E.getItem("state"))try{e=JSON.parse(e),w||(T.width=parseInt(e.width,10)||d.width,T.height=parseInt(e.height,10)||d.height),e.sortDirection&&/^(asc|desc)$/.test(e.sortDirection)&&(T.sortDirection=e.sortDirection),d.columns[e.sortColumn]&&(T.sortColumn=e.sortColumn);for(let[t,a]of Object.entries(e.columnWidths))a=parseInt(a,10),a&&(T.columnWidths[t]=a)}catch(e){}}(),y=function(){return"<div class='a-PopupLOV-dialog'></div>"},L.data("popupSearchState",{forceRefresh:e,typeAhead:p,searchText:n}),!P("#"+t.escapeCSS(V))[0]&&T){if(d.width=T.width||d.width,d.height=T.height||d.height,T.sortColumn&&T.sortDirection)for(const[e,t]of Object.entries(d.columns))e===T.sortColumn&&t.canSort?(t.sortIndex=1,t.sortDirection=T.sortDirection):(delete t.sortIndex,delete t.sortDirection);if(T.columnWidths)for(const[e,t]of l(T.columnWidths))d.columns[e]&&(d.columns[e].width=t)}g={id:V,title:d.title||a.getMessage("APEX.POPUP_LOV.TITLE"),isPopup:w,parentElement:w?L.closest(".apex-item-group--popup-lov"):null,returnFocusTo:L[0],noOverlay:!0,draggable:!0,resizable:!0,width:200,height:d.height,okButton:!1,dialogClass:"ui-dialog-popuplov",notification:!1,callback:function(){var e,t,a,n="setValue",i=apex.item(d.itemId);if(d.multiple&&(n="addValue"),M&&("object"==typeof M&&o(M,"d")&&o(M,"v")?i[n](M.v,M.d):"object"==typeof M&&o(M,"v")?i[n](M.v):i[n](M),!d.multiple&&(e=d.extraOut)))for(const[n,i]of l(e))a=null,null!==(t=M[n])&&"object"==typeof t&&o(t,"d")&&(a=(t=t.v).d),$s(i.item,t,a);v.setSelectedRecords([],!1),h&&h(M)},init:function(o){var l,h,g,y,E,V,D,k,R=null,X=null,j=O+"_m",z=o.is(":data(apexPopup)")?"popup":"dialog",F=a.getMessage("APEX.POPUP.SEARCH"),N={forceRefresh:e,typeAhead:p,searchText:A||n},W=t.htmlBuilder();function B(e){return e.match(/^[A-Z0-9_$#]+$/)?"&"+e+".":'&"'+e+'".'}function U(){var e=v.getSelectedRecords()[0];e&&(M={v:f.getValue(e,d.valueColumn)},d.hasDisplayValue&&d.displayColumn&&(M.d=f.getValue(e,d.displayColumn)),d.extraOut&&Object.keys(d.extraOut).forEach((function(t){M[t]=f.getValue(e,t)})),o[z]("close"))}function G(e,t,a){var n=null;return!e.term||a&&!1===a.canSearch?t:t.replace(e.re,(function(e,t,a){if(t){switch(t){case"<":n=t;break;case">":"<"===n&&(n=null);break;case"&":n||(n=t);break;case";":"&"===n&&(n=null)}return t}return n||!a.length?a:"<span class='popup-lov-highlight'>"+a+"</span>"}))}L.data("popupSearchState",N),W.markup("<div><div").attr("class","a-PopupLOV-searchBar"+(_?" a-PopupLOV--incremental":"")).markup("><input type='text' aria-label='"+F+"' maxlength='100' class='a-PopupLOV-search apex-item-text'").attr("value",A).markup(">"),_||W.markup("<button type='button' class='a-Button a-PopupLOV-doSearch' aria-label='"+F+"'>"),W.markup("<span class='a-Icon icon-search' aria-hidden='true'></span>"),_||W.markup("</button>"),W.markup("</div>"),d.nullDisplayValue&&W.markup("<div class='a-PopupLOV-clear'><button class='a-PopupLOV-clearButton' type='button'>").content(d.nullDisplayValue).markup("</button></div>"),W.markup("<div class='a-PopupLOV-results'></div></div></div>"),D=i(W.toString()),m=D.find(".a-PopupLOV-results"),C=D.find(".a-PopupLOV-searchBar"),b=C.find(".a-PopupLOV-search"),k=C.find(".a-PopupLOV-doSearch"),x=D.find(".a-PopupLOV-clearButton");for(const[e,t]of Object.entries(d.columns))if(t.sortIndex){R=e,X=t.sortDirection;break}if(f=apex.model.create(j,{shape:"table",hasTotalRecords:!1,recordIsArray:!0,identityField:d.valueColumn,metaField:d.columns._meta?"_meta":null,fields:d.columns,paginationType:"progressive",regionId:d.itemId,fetchData:{search:null,sortColumn:R,sortDirection:X},requestOptions:d.pluginTarget?{target:d.pluginTarget}:null,ajaxIdentifier:d.ajaxIdentifier,pageItemsToSubmit:d.itemsToSubmit},[],0,!1),L.data("popupLovModelName",j),E=d.displayColumn||d.valueColumn,"grid"===d.display)d.columns[E].usedAsRowHeader=!0,d.iconColumn&&(y="<span class='"+B(d.iconColumn)+"'></span> "+B(E),d.columns[E].cellTemplate=y),l=s({modelName:j,columns:[d.columns],columnSort:!0,columnSortMultiple:!1,collapsibleControlBreaks:!1,footer:!1,hasSize:!0,noDataMessage:I,multiple:!1,pagination:{scroll:!0,loadMore:!0},constrainNavigation:!1,reorderColumns:!1,resizeColumns:!0,highlighter:G,activateCell:function(e){var t=i(e.target).closest(".a-GV-cell");"keydown"===e.type&&e.which!==r||t.hasClass("a-GV-selHeader")||t.hasClass("has-button")||U()},selectionChange:function(e){e.originalEvent&&"click"===e.originalEvent.type&&U()},sortChange:function(e,t){var a,n,i,o=t.column.sortIndex,l=g.grid("getColumns");for(i=1,a=0;a<l.length;a++)(n=l[a]).sortIndex&&("change"===t.action?n===t.column&&(i=n.sortIndex):"add"===t.action?n.sortIndex>=i&&(i=n.sortIndex+1):"remove"===t.action?n===t.column?(delete n.sortIndex,delete n.sortDirection):n.sortIndex>o&&(n.sortIndex-=1):"clear"!==t.action&&"set"!==t.action||(delete n.sortIndex,delete n.sortDirection));"clear"!==t.action&&"remove"!==t.action&&(t.column.sortIndex=i,t.column.sortDirection=t.direction),g.grid("refreshColumns"),H(N,null,t.column.property,t.direction),T&&(T.sortColumn=t.column.property,T.sortDirection=t.direction,$())},columnResize:function(e,t){T&&(T.columnWidths[t.column.property]=parseInt(t.width,10),$())}},d.defaultGridOptions),(g=m).grid(l),v=g.data("apex-grid"),g.on("click",(function(e){i(e.target).closest(".a-GV-row").hasClass("is-selected")&&U()}));else{if("list"!==d.display)throw new Error("Invalid display value");(y=d.recordTemplate)?y=y.replace("&DISPLAY.","&"+E+".").replace("&ICON.","&"+d.iconColumn+".").replace("&RETURN.","&"+d.valueColumn+"."):(y="<li data-id='"+B(d.valueColumn)+"'>",d.iconColumn&&(y+="<span class='"+B(d.iconColumn)+"'></span> "),y+=B(E)+"</li>"),h=s({modelName:j,recordTemplate:y,footer:!1,hasSize:!0,noDataMessage:I,highlighter:G,useIconList:!0,constrainNavigation:!1,iconListOptions:{navigation:!0,multiple:!1,activate:function(e){U(),e.preventDefault()}},pagination:{scroll:!0,loadMore:!0}},d.defaultIconListOptions),m.tableModelView(h),v=m.data("apex-tableModelView")}o.append(D.children()),d.minSearchChars>0&&(S=a.formatMessage("APEX.POPUP_LOV.FILTER_REQ",d.minSearchChars)),S||"none"!==d.initialFetch||(S=a.getMessage("APEX.POPUP_LOV.INITIAL_FILTER_REQ")),_&&(V=t.debounce((function(){H(N,b.val())}),400)),m.keydown((function(e){var t=e.which;e.isDefaultPrevented()||(t===u?P(b).trigger("focus"):t===c&&(x[0]?x.add(b).last().trigger("focus"):(P(b).trigger("focus"),e.preventDefault())))})).focusin((function(){var e=v.getSelection();0===e.length&&(e=i(m[0].ownerDocument.activeElement).closest(".a-IconList-item,.a-GV-row"))[0]&&v.setSelection(e)})),b.keydown((function(e){var t,a=e.which;a===u?(x[0]?x.trigger("focus"):v.focus(),e.preventDefault()):a===c?(v.focus(),e.preventDefault()):9===a&&_?1===f.getTotalRecords()&&(g?g.grid("setSelection",g.find(".a-GV-cell").eq(0)):v.focus(),U(),e.preventDefault(),e.stopPropagation()):a===r?(e.preventDefault(),_&&d.enterable&&w&&b.val()?(M={v:b.val()},o[z]("close")):_&&!d.enterable&&1===f.getTotalRecords()?(t=null,f.forEach((function(e){t=e})),t&&(v.setSelectedRecords([t]),U())):H(N,b.val())):_&&V()})),k.on("click",(function(){H(N,b.val())})),x.on("click",(function(){M={v:d.nullValue,d:d.nullDisplayValue},d.extraOut&&Object.keys(d.extraOut).forEach((function(e){M[e]=""})),o[z]("close")})).keydown((function(e){var t=e.which;t===u?(v.focus(),e.preventDefault()):t===c&&(P(b).trigger("focus"),e.preventDefault())})),o.attr("role","application")},open:function(e){var t,a,n,o,l=L.data("popupSearchState"),s=l.searchText||"",r=P(e.target),c=r.is(":data(apexPopup)")?"popup":"dialog";d.width||(t=L.closest(".apex-item-group--popup-lov").width()),w&&(n=i(window).width()-10,o=i(window).height()-10,(d.width||t)>n&&(t=n),d.height>o&&(a=o)),t&&r[c]("option","width",t),a&&r[c]("option","height",a),D(e.target),M=null,(s||l.forceRefresh)&&(b.val(s),H(l,s)),b.trigger("focus")},resize:function(e){D(e.target)},resizeStop:function(e,t){T&&!w&&(T.height=t.size.height,T.width=t.size.width,$())}},["draggable","resizable","width","height","minWidth","minHeight","maxWidth","maxHeight","noOverlay"].forEach((function(e){void 0!==d[e]&&(g[e]=d[e])})),apex.message.showDialog(y,g)};var D=function(e,t){e.sort((function(e,t){return e.name<t.name?-1:e.name>t.name?1:0})),"label-desc"===t&&e.reverse()};e.chartSortArray=D,e.chartFillGaps=function(e,t,a,n){D(t,a);for(var i=0;i<e.length;i++)t[i]&&t[i].name===e[i].name?t[i].id!==i&&(t[i].id=i):t.splice(i,0,{name:e[i].name,value:n?0:null})},e.enableIcon=function(e,t,a){e.find("img").css({opacity:1,cursor:""}).parent("a").attr("href",t),a&&e.on("click",a)},e.disableIcon=function(e){e.find("img").css({opacity:.5,cursor:"default"}).parent("a").removeAttr("href").off("click")},e.indexOfMatch=function(e,t,a,n){let i,o,l=-1;return n?(i=e,o=t):(i=e.toLowerCase(),o=t.toLowerCase()),a===L?l=i.startsWith(o)?0:-1:a===A&&(l=i.indexOf(o)),l},e.highlightSearchTerm=function(a,n,i,o,l){let s;const r=e.indexOfMatch(a,n,i,o);if(n&&r>-1){const e=r+n.length-1,i=a.slice(0,r),o=a.slice(r,e+1),c=a.slice(e+1);s=`${t.escapeHTML(i)}<span class='${l}'>${t.escapeHTML(o)}</span>${t.escapeHTML(c)}`}return s};var H=[];function $(e){var t;for(t=0;t<H.length;t++)if(H[t].el===e)return t;return null}e.onVisibilityChange=function(e,t){var a=$(e),n={el:e,cb:t};null!==a?H[a]=n:H.push(n)},e.offVisibilityChange=function(e){var t=$(e);null!==t&&H.splice(t,1)},e.isVisible=function(e){var t,a,n=e.is(":visible");return e.closest("div.apex-tabs-region").length>0&&(t=apex.region(e.closest("div.apex-tabs-region").attr("id")).widget())&&(a=t.aTabs("getActive").el$,0===e.parents("#"+a.attr("id")).length&&(n=!1)),n},e.whenBecomesVisible=function(t,a){setTimeout((function(){e.isVisible(t)?a(t):e.onVisibilityChange(t[0],(function(n){n&&(a(t),e.offVisibilityChange(t[0]))}))}),0)};var k=e.visibilityChange=function(e,t){var a,n,o,l=i(e);for(t=!!t,a=0;a<H.length;a++)o=H[a],t===(n=i(o.el)).is(y)&&n.closest(l).length&&o.cb(t)};i(document).on("apexaftershow",(function(e){k(e.target,!0)})).on("apexafterhide",(function(e){k(e.target,!1)}));var R="apex-resize-sensor";e.onElementResize=function(e,t){var a,n;"string"==typeof e&&(e="#"+e),(n=(a=i(e).first()).data(R))||(n=new X(a[0]),a.data(R,n),n.start()),n.addListener(t)},e.offElementResize=function(e,t){var a,n;"string"==typeof e&&(e="#"+e),(n=(a=i(e).first()).data(R))&&(t?(n.removeListener(t),n.isEmpty()&&(n.stop(),a.removeData(R))):(n.destroy(),a.removeData(R)))},e.updateResizeSensors=function(e){"string"==typeof e&&(e="#"+e),i(e).find(".js-resize-sensor").parent().each((function(e,t){var a=i(t).data(R);null!=a&&a.init(!0)}))};var X=function(e){var a=i.Callbacks(),n=0,o=null,l=null,s=null,r=null,c=null,u=null,p=null;function d(e){var t=!1;if(null!=r.offsetParent){var a=r.offsetWidth,i=r.offsetHeight;l===a&&s===i||(n=2,v(a,i),t=!0,e&&h(!0))}return t}function h(n){var i=e.offsetWidth,l=e.offsetHeight;a.has()&&(n?(null!==o&&t.cancelInvokeAfterPaint(o),o=t.invokeAfterPaint((function(){o=null,a.fire(i,l)}))):a.fire(i,l))}function f(e){e.stopPropagation(),d(!0)||n>0&&null!=r.offsetParent&&(0==r.scrollLeft||0==r.scrollTop)&&(n--,v(l,s))}function m(){h(!1)}function v(e,t){l=e,s=t;var a=r.firstChild.style,n=1;do{a.width=e+n+"px",a.height=t+n+"px",r.scrollLeft=r.scrollTop=n,n++}while((0==r.scrollTop||0==r.scrollLeft)&&n<=5);c.scrollLeft=e,c.scrollTop=t}this.addListener=function(e){a.add(e)},this.removeListener=function(e){a.remove(e)},this.isEmpty=function(){return!a.has()},this.destroy=function(){a.empty(),this.stop()},this.start=function(){function t(e,t){e.direction="ltr",e.position=t.position="absolute",e.left=e.top=e.right=e.bottom="0",e.overflow="hidden",e.zIndex="-1",e.visibility="hidden",t.left=t.top="0",t.transition="0s"}if(p=f.bind(this),e.attachEvent)u=m.bind(this),e.attachEvent("onresize",u);else{var a=e.childNodes[0];(r=document.createElement("div")).className="js-resize-sensor";var n=document.createElement("div");t(r.style,n.style),r.appendChild(n),a?e.insertBefore(r,a):e.appendChild(r),r.addEventListener("scroll",p,!1),c=document.createElement("div");var i=document.createElement("div");t(c.style,i.style),i.style.width="200%",i.style.height="200%",c.appendChild(i),e.insertBefore(c,r),c.addEventListener("scroll",p,!1),this.init(!1)}},this.stop=function(){null!==o&&(t.cancelInvokeAfterPaint(o),o=null),null!==r?(r.removeEventListener("scroll",p),c.removeEventListener("scroll",p),r.parentNode&&e.removeChild(r),c.parentNode&&e.removeChild(c)):e.detachEvent("onresize",u)},this.init=function(e){var t=d(e);e&&!t&&null!=r.offsetParent&&v(l,s)}};e.TouchProxy=function(e){this._init(e)},e.TouchProxy.prototype._init=function(e){this._elem=e,this._touchHandled=!1,this._touchMoved=!1,this._touchStartHandler=i.proxy(this._touchStart,this),this._touchEndHandler=i.proxy(this._touchEnd,this),this._touchMoveHandler=i.proxy(this._touchMove,this),this._elem[0]&&(this._elem[0].addEventListener("touchstart",this._touchStartHandler,{passive:!1}),this._elem[0].addEventListener("touchend",this._touchEndHandler,{passive:!1}),this._elem[0].addEventListener("touchmove",this._touchMoveHandler,{passive:!1}),this._elem[0].addEventListener("touchcancel",this._touchEndHandler,{passive:!1}))},e.TouchProxy.prototype._destroy=function(){this._elem&&this._touchStartHandler&&(this._elem[0].removeEventListener("touchstart",this._touchStartHandler),this._elem[0].removeEventListener("touchend",this._touchEndHandler),this._elem[0].removeEventListener("touchmove",this._touchMoveHandler),this._elem[0].removeEventListener("touchcancel",this._touchEndHandler),this._touchStartHandler=void 0,this._touchEndHandler=void 0,this._touchMoveHandler=void 0)},e.TouchProxy.prototype._touchHandler=function(e,t){if(!(e.originalEvent.touches.length>1)){"touchstart"!=e.type&&"touchend"!=e.type&&e.preventDefault();var a=e.originalEvent.changedTouches[0],n=document.createEvent("MouseEvent");n.initMouseEvent(t,!0,!0,window,1,a.screenX,a.screenY,a.clientX,a.clientY,!1,!1,!1,!1,0,null),a.target.dispatchEvent(n)}},e.TouchProxy.prototype._touchStart=function(e){this._touchHandled||(this._touchHandled=!0,this._touchMoved=!1,this._touchHandler(e,"mouseover"),this._touchHandler(e,"mousemove"),this._touchHandler(e,"mousedown"))},e.TouchProxy.prototype._touchMove=function(e){this._touchHandled&&(this._touchMoved=!0,this._touchHandler(e,"mousemove"))},e.TouchProxy.prototype._touchEnd=function(e){this._touchHandled&&(this._touchHandler(e,"mouseup"),this._touchHandler(e,"mouseout"),this._touchHandled=!1)},e.TouchProxy._TOUCH_PROXY_KEY="apexTouchProxy",e.TouchProxy.prototype.touchMoved=function(){return this._touchMoved},e.TouchProxy.addTouchListeners=function(t){var a=i(t),n=a.data(e.TouchProxy._TOUCH_PROXY_KEY);return n||(n=new e.TouchProxy(a),a.data(e.TouchProxy._TOUCH_PROXY_KEY,n)),n},e.TouchProxy.removeTouchListeners=function(t){var a=i(t),n=a.data(e.TouchProxy._TOUCH_PROXY_KEY);n&&(n._destroy(),a.removeData(e.TouchProxy._TOUCH_PROXY_KEY))}}(apex.widget.util,apex.util,apex.lang,apex.navigation,apex.jQuery);
